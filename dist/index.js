...
const opsworks_1 = __importDefault(__webpack_require__(542));
const deploy = ({ region, StackId, AppId }) => __awaiter(void 0, void 0, void 0, function* () {
    const opsworks = new opsworks_1.default({ region });
    const { DeploymentId } = yield opsworks
        .createDeployment({
        Command: {
            Name: 'deploy',
            Args: {}
...
const waitFor = ({ region, DeploymentId }) => __awaiter(void 0, void 0, void 0, function* () {
    const opsworks = new opsworks_1.default({ region });
    const { Deployments } = yield opsworks
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const DeploymentId = yield deploy({ region, StackId, AppId });
...
Object.defineProperty(apiLoader.services['opsworks'], '2013-02-18', {
  get: function get() {
    var model = __webpack_require__(617);
    model.paginators = __webpack_require__(152).pagination;
    model.waiters = __webpack_require__(242).waiters;
    return model;
  },
  enumerable: true,
  configurable: true
